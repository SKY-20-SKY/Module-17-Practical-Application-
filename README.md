...
* **Features**: 21 variables, including:
    * **Client Data**: Age, job, marital status, and education.
    * **Contact Information**: Month, day of the week, and duration.
    * **Social/Economic Indicators**: Employment variation rate, consumer price index, and consumer confidence index.
...
* **Economic Indicators**: Indicators such as the **employment variation rate (emp.var.rate)** and the **3-month Euribor rate (euribor3m)** show strong positive correlations with each other but are negatively correlated with subscription rates.
* **Demographics**: Initial exploration suggests that older customers have a higher probability of subscribing.
* **Contact Frequency**: Excessive contacts during a single campaign do not necessarily lead to better outcomes.
...
* **Next Steps**: Further data analysis and advanced sampling techniques (such as SMOTE) are needed to address the class imbalance and improve the detection of subscribers.
